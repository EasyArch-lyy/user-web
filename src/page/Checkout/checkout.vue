...
<!--  private Long memberId;
    ...
    private String detailAddress;         -->
          <y-button text='保存'
                    ...
                    @btnClick="save({memberId:userId,addressId:msg.addressId,userName:msg.userName,tel:msg.tel,streetName:msg.streetName,isDefault:msg.isDefault})">
          </y-button>
        </div>
      </y-popup>
    </div>
...
<script>
  import { addressUpdate, addressDel, productDet, submitOrder } from '/api/goods'
  // deleteReceiveAddress, updateReceiveAddress, getReceiveAddressMsg
  import { getReceiveAddress, addReceiveAddress } from '/api/user'
      ...
      _addressList () {
        getReceiveAddress().then(res => {
          ...
          if (data.length) {
            ...
            this.streetName = data[0].detailAddress
          } else {
            this.addList = []
          }
        })
